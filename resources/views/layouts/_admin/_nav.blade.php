  ...
  <div class="nav-wrapper blue">
    <div class="container">
      ...
      <ul class="right hide-on-med-and-down">
        ...
        @else
          <li>
            <a href="#!" class="dropdown-button" data-activates="dropdown1">{{ Auth::user()->name }}<i class="material-icons right">arrow_drop_down</i></a>
          </li>
      ...
      <ul class="side-nav" id="mobile-demo"><!-- Menu para Mobile -->
        <li><a href="{{ route('admin.principal') }}">Início</a></li>
        <li><a href="{{ route('site.home') }}" target="_blank">Site</a></li>
        @if(Auth::guest())
          <li><a href="{{ route('admin.login') }}">Login</a></li>
